...
<section>
	<img src="images/trial.jpg" alt="sign up for a free google workspace trial" style="width:100%;height: auto;">
</section>

<section class="contact-form">
	<div class="sec-title centered">
		<h1>Get A <span style="color:#0c82dc;">Free Trial</span></h1>
		<p><a  style="color:#000;" href="get-signup-free-trial-google-workspace-gsuite-shrishti-softech.php">Sign Up for Google for Workspace Free Trial</a></p>
		<p style="font-size:16px; color:#000;">Welcome to the Web Page of <a href="https://skynetiks.com/" target="_blank" style="color:#0c82dc;">Skynetiks Technologies</a> - Google for <a style="color:#0c82dc;"href="https://cloud.withgoogle.com/partners/detail/?id=shrishti-softech-solutions-pvt-ltd&hl=en-US">Workspace Partner</a> in India. <br>We Thank you for your interest shown in signing up for a free trial for Google for Workspace formerly known as <br>Google Apps for Business & GSuite. </p>
		<h5><span style="color:#0c82dc;"><b>IT IS GOOD TO TRY BEFORE YOU BUY!</span></b></h5>
		<p style="color:#000;">Please fill in your details below and our Google Support Agent will ensure to activate your services.  <br><b>Support Contacts :</b> <a style="color:#0c82dc;" href="mailto:googletrials@ssi.bz">googletrials@ssi.bz</a> <b>Ph:</b> <a href="tel:8882460460" style="color:#0c82dc;">+91 8882460460</a></p>
	</div>
    ...
    <div class="row" style="padding-top:25px;">
      <div class="col-md-9">
       <form  action="product.php" method="POST">
        ...
        <img src="images/skynetiks-logo-resized.webp" style="    width: 100%;
    margin-bottom: 10px;
    background: #d2ecfa;
    padding: 22px;">
