...
<section class="about-page-section">
	...
	<div class="container">
      <p style="text-align:left;"> <a href="https://skynetiks.com/" target="_blank">Skynetiks Technologies:</a> <strong>A SAP, Google, Acronis & Microsoft partner</strong> was founded in year 2003 with an objective of <strong>IT consulting & custom software development</strong>. Later, realizing the importance of internet technology future, Skynetiks Technologies associated with Times Internet Limited for distribution and delivery of the mailing solution meramail.com
      </p>

      <p style="text-align:left;">A name reckoned with for its reliability and dependability, Skynetiks Technologies is known for impeccable technical expertise and delivering capabilities. <strong>A great renewal ratio 87% is an evident achievement. In the span of two decade, we have served more than 5k satisfied customers</strong> from all the segments of business. Majority of these are SME's and medium enterprises. The industry verticals served are pharma, automobile, garments, healthcare, infrastructure, event management, discrete manufacturing.</p>
   </div>
