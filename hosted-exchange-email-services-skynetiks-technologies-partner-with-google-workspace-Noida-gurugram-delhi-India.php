...
<section class="city" style="background:linear-gradient(rgb(33 109 161 / 81%), rgb(1 87 146 / 33%)),url(images/hosted-exchange.jpg);background-repeat: no-repeat;
	...
	<div class="container">
		<div class="text-center city_banner">
			<h4>What makes Hosted Exchange the Best Business Email Solution ?</h4>
			<div class="btns-box">
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="text-content">
					<p>Hosted exchange is a telecommunications service where a service provider offers microsoft email boxes and storage space on a server for clients to host their data. The service provider takes care of managing the hosted data for its clients on the server.
					</p>
					<p><strong>Hosted exchange from skynetiks Technologies offers the most reliable business email hosting with 24/7 support with 99.99% uptime guarantee and free migration.</strong></p>
				<p><strong>Our team of experts will migrate your data from any email platform with no downtime.</strong> We will work with you to develop a custom strategy that fits your business needs. <strong>It combines the power of Microsoft Exchange with the flexibility of cloud hosting,</strong> offering enterprise-grade features without the high cost of in-house servers.</p>
